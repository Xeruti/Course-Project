    ...
    useEffect(() => {
        ...
        axios.get('/courses/'+id).then(response => {
           ...
           if(data.startDate){
            ...
            if(data.startDate){
                endDate = (data.returnDate).substring(0, 10)
            }
        ...
        <div className="container m-auto">
            <AccountNavigation/>
                    <form onSubmit={AddNewCourse}>
                        <h2 className="text-xl mt-4">Nazwa kursu</h2>
                        <input type='text' value={title} onChange={e => setTitle(e.target.value)}  placeholder="Nazwa kursu"></input>
                        <h2 className="text-xl mt-4">Wstępny opis</h2>
                        <input type='text' value={shortDescription} onChange={e => setShortDescription(e.target.value)} placeholder="Wstępny opis kursu"></input>
                        ...
                        <div className="mt-2 grid grid-cols-2 gap-3">
                            ...
                            <div>
                                <h2 className="text-xl mt-4">Data Startu</h2>
                            ...
                            <div>
                                <h2 className="text-xl mt-4">Data Zakończenia</h2>
                                <label className="border p-4 flex gap-2 items-center cursor-pointer">
...

                        {
                            id !== undefined && (
                                <div className="my-3 grid grid-cols-1 place-items-center mx-20">
                                    <div className="w-full">
                                        <button onClick={deleteCourse} className="primary bg-red-100">Usuń</button>
                                    </div>
                                </div>
                            )
                        }
